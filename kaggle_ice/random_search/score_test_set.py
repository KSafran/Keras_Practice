...
model = create_model(nchannels = 2, base_size = 42, 
	 drop = 0.06767, activation = 'relu', normalize_batches = False, 
	 angle = False)
...
submission_data = get_image_tensor(submission_data, extra_channel = 'none', normalize = False)
