...
# "flat" images into 8x8 images
training_shaped = mnist.data.reshape(mnist.data.shape[0], 8, 8)
...
# You need to specify the input shape of the first layer. 
mnist_model.add(Conv2D(25, (3, 3), input_shape=(8,8), activation = 'relu'))
mnist_model.add(Conv2D(25, (3, 3), input_shape=(8,8), activation = 'relu'))
